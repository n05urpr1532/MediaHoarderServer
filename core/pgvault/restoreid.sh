...
/mhs/backup and you should see the list there!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
EOF
  ...
  rcheck=$(rclone --config /opt/mhs/etc/rclone/rclone.conf ls gdrive:/mhs/backup/$typed)
  if [ "$rcheck" == "" ]; then
    tee <<- EOF
...
EOF
  ...
  echo "$typed" > /var/mhs/state/restore.id
