...
PMSdir="/opt/mhs/apps-data/plex/database/Library/Application Support/Plex Media Server"
prefFile="/opt/mhs/apps-data/plex/database/Library/Application Support/Plex Media Server/Preferences.xml"
...
<Preferences/>
EOF
  chown -R 1000:1000 "/opt/mhs/apps-data/plex"
fi
