...
EOF
 ...
 echo
  ...
  case $typed in
  1) ansible-playbook /opt/mhs/lib/menu/traktarr/traktarr-list/prefillallow.yml && question1 ;;
  2) ansible-playbook /opt/mhs/lib/menu/traktarr/traktarr-list/prefillremove.yml && question1 ;;
  z) exit ;;
  Z) exit ;;
  *) question1 ;;
  esac
...
EOF
    ...
    ansible-playbook /opt/mhs/lib/menu/mhs.yml --tags traktarr && question1 ;;
