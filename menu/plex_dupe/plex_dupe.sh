...
source /opt/mhs/lib/menu/plex_dupe/scripts/endbanner.sh
...
EOF
  ...
  1)
	...
	if [[ -f $file ]]; then
	  ...
	  ansible-playbook /opt/mhs/lib/menu/mhs.yml --tags plex_dupefinder >/dev/null 2>&1
...
EOF
 ...
 case $typed in
 1) clear && question1 ;;
 2) ansible-playbook /opt/mhs/lib/menu/plex_dupe/remove/remove.yml && question1 ;;
 *) badinput ;;
 esac
}
...
EOF
  ...
  A) ansible-playbook /opt/mhs/lib/menu/mhs.yml --tags plex_dupefinder && clear && endbanner && question1 ;;
  a) ansible-playbook /opt/mhs/lib/menu/mhs.yml --tags plex_dupefinder && clear && endbanner && question1 ;;
