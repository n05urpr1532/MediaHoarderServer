...
source /opt/mhs/lib/menu/gce/functions/main.sh
source /opt/mhs/lib/menu/gce/functions/interface.sh
source /opt/mhs/lib/menu/gce/functions/ip.sh
source /opt/mhs/lib/menu/gce/functions/deploy.sh
source /opt/mhs/lib/menu/gce/functions/destroy.sh
