...
source /opt/mhs/lib/menu/functions/nvidia.sh
source /opt/mhs/lib/menu/functions/uichange.sh
...
EOF
  ...
  case $typed in
  Y) ansible-playbook /opt/mhs/lib/menu/rclonededupe/dupedeploy.yml && setstart ;;
  y) ansible-playbook /opt/mhs/lib/menu/rclonededupe/dupedeploy.yml && setstart ;;
  N) ansible-playbook /opt/mhs/lib/menu/rclonededupe/duperemove.yml && setstart ;;
  n) ansible-playbook /opt/mhs/lib/menu/rclonededupe/duperemove.yml && setstart ;;
  z) setstart ;;
  Z) setstart ;;
  *) setstart ;;
...
EOF
  ...
  case $typed in
  1) bash /opt/mhs/lib/menu/multihd/multihd.sh ;;
  ...
  3)
    ...
    setstart ;;
  4) bash /opt/mhs/lib/menu/functions/network.sh && clear && setstart ;;
  5) setupnew && clear && setstart ;;
  6) nvidia && clear && setstart ;;
  7) rcdupe ;;
###########################################################################
  99) bash /opt/mhs/lib/menu/functions/tshoot.sh && clear && setstart ;;
  z) exit ;;
  Z) exit ;;
  *) setstart ;;
  esac
