...
ctoken() {
bash /opt/mhs/lib/menu/plexpatrol/token.sh && clear
}
...
EOF
 ...
 case $typed in
 1) question1 ;;
 2) ansible-playbook /opt/mhs/lib/menu/plexpatrol/remove-plexpatrol.yml && question1 ;;
 *) badinput ;;
 esac
}
credits(){
...
EOF
  ...
  7) ansible-playbook /opt/mhs/lib/menu/mhs.yml --tags plexpatrol && sleep 5 && clear &&  exit ;;
