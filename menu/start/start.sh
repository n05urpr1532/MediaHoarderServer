...
EOF
  ...
  case $typed in
  1) clear && bash /opt/mhs/lib/menu/pgcloner/traefik.sh && clear && primestart ;;
  2) clear && bash /opt/mhs/lib/menu/portguard/portguard.sh && clear && primestart ;;
  3) clear && bash /opt/mhs/lib/menu/shield/pgshield.sh && clear && primestart ;;
  4) clear && bash /opt/mhs/lib/menu/pgcloner/pgclone.sh && clear && primestart ;;
  5) clear && bash /opt/mhs/lib/menu/pgbox/select.sh  && clear && primestart ;;
  6) clear && bash /opt/mhs/lib/menu/pgcloner/pgvault.sh  && clear && primestart ;;
  7) clear && bash /opt/mhs/lib/menu/traktarr/traktarr.sh  && clear && primestart ;;
  z) clear && bash /opt/mhs/lib/menu/interface/ending.sh &&  exit ;;
  Z) clear && bash /opt/mhs/lib/menu/interface/ending.sh && exit ;;
  *) primestart ;;
  esac
}
...
EOF
  ...
  4) clear && bash /opt/mhs/lib/menu/pgcloner/pgclone.sh && clear && primestart ;;
  5) clear && bash /opt/mhs/lib/menu/pgbox/select.sh && clear && primestart ;;
  6) clear && bash /opt/mhs/lib/menu/pgscan/pgscan.sh && clear && primestart ;;
  7) clear && bash /opt/mhs/lib/menu/pgcloner/pgpress.sh && clear && primestart ;;
  8) clear && bash /opt/mhs/lib/menu/pgcloner/pgvault.sh && clear && primestart ;;
  9) clear && bash /opt/mhs/lib/menu/interface/cloudselect.sh && clear && primestart ;;
  10) clear && bash /opt/mhs/lib/menu/plex_dupe/plex_dupe.sh && clear && primestart ;;
  11) clear && bash /opt/mhs/lib/menu/traktarr/traktarr.sh && clear && primestart ;;
  12) clear && bash /opt/mhs/lib/menu/plexpatrol/plexpatrol.sh && clear && primestart ;;
  13) clear && bash /opt/mhs/lib/menu/interface/settings.sh && clear && primestart ;;
  z) clear && bash /opt/mhs/lib/menu/interface/ending.sh  && exit ;;
  Z) clear&& bash /opt/mhs/lib/menu/interface/ending.sh && exit ;;
  *) primestart ;;
  esac
